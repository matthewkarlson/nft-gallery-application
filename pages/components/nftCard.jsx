    ...
    return (
        ...
        <div className="flex flex-col y-gap-2 px-2 py-3 bg-slate-100 rounded-b-md h-110 ">
            <div className="">
                ...
                <p className="text-gray-600" > {`${nft.contract.address.substr(0,3)}...${nft.contract.address.substr(-3)}`} <button  className={""} onClick={() => {navigator.clipboard.writeText(nft.contract.address)}}>Copy to clipboard</button></p>
            </div>
